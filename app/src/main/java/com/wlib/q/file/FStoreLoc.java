...
import com.wlib.q.exception.SdCardNotMountedException;
import com.wlib.q.exception.SdCardNotValidException;
import com.wlib.q.phone.Storage;
import com.wlib.q.phone.Storage.SdCard;
...
public class FStoreLoc {
	...
	private SdCard getAnother(SdCard current) {
		...
		L.i(FStoreLoc.class, "getAnother----sdcardTo:" + sdcardTo);
		return sdcardTo;
	}
